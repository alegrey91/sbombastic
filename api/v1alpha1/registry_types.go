...
// Repository contains fields to identify repositories from the catalog.
type Repository struct {
	// Name is an identifier for the image name to be scanned.
	Name string `json:"name"`
	// MatchConditions is a list of CEL expressions to identify the image tag.
	MatchConditions []MatchCondition `json:"matchConditions,omitempty"`
}

// MatchCondition contains the CEL expression to match for image tags.
...
// GetMatchConditionsByRepository returns the list of MatchConditions
// that belong to the repository given in input.
// If the repository given in input does not exist or does not have
// MatchConditions, the function returns an empty list.
